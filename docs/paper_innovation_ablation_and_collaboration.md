...
|---|---|---|---|---|
| 句子条件的 KG 机制证据压缩 | 先识别 metabolism、absorption、renal clearance、QT 等句子 cue，再筛选 CYP、UGT、SLC、ABC、离子通道等机制锚点，最后生成 Evidence Summary | 原始一阶邻居噪声大，节点关联不等于因果关系 | No-KG、Raw-KG、规则过滤 KG、句子条件 Filtered-KG 四级消融 | 规则思想明确，正式数据待重建 |
...
| M3 | Qwen-Plus | Direct | No-KG | 关闭 | 0.0289 | 0.4538 | 0.7252 | — | 8.4904 | 0.2831 |
| M4 | Qwen-Plus | Direct | Raw-KG | 关闭 | 待运行 | 待运行 | 待运行 | 待运行 | 待运行 | 待运行 |
